...
<div class="row">
	...
	<div class="col-md-8">
		...
		<a href="<?php echo base_url('perawat/dashboard/ubah') ?>" class="btn btn-warning">Ubah Profil</a>
		<a href="<?php echo base_url('perawat/dashboard/ubahPassword') ?>" class="btn btn-primary">Ubah Password</a>
	</div>
</div>